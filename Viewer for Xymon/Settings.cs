...
namespace Viewer_for_Xymon
{
    public static class Settings
    {
        ...
        public static bool createdCaseToClipboard = true;
        ...
        public static string ackHistURL = String.Empty; 
    ...
    public class SettingsManager : BindableBase
    {
        ...
        public SettingsManager()
        {
            ...
            histPattern = Settings.histPattern;
            ackHistURL = Settings.ackHistURL;
            ackHistPattern = Settings.ackHistPattern;
            histLimit = Settings.histLimit;
